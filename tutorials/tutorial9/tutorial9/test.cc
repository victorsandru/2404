...
int testAddRemove(){
    ...
    if (arr.getSize()!=10){
      cout<<"Error, size of array should be 10, instead it is "<<arr.getSize()<<endl;
      return 1;
    }else{
    ...
    if (arr.getSize()!=5){
      cout<<"Error, size of array should be 5, instead it is "<<arr.getSize()<<endl;
      return 1;
    }else{
    ...
    arr.clear();
    if (arr.getSize()!=0){
      cout<<"Error, size of array should be 0, instead it is "<<arr.getSize()<<endl;
      return 1;
    }else{
